...
int main() {
	...
	while (cin >> a) {
		...
		bool ok = false, leapy = false;;
		
		if ( a % 400 == 0 or (a % 100 != 0 and a % 4 == 0))
			cout << "This is leap year." << endl, ok = true, leapy = true;
		if (a % 15 == 0)
			cout << "This is huluculu festival year." << endl, ok = true;
		if (a % 55 == 0 and leapy) 
			cout << "This is bulukulu festival year." << endl, ok = true;
