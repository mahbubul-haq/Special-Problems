...
/// source : http://mewtomat.blogspot.com/2016/03/spoj-gny07h-tiling-grid-with-dominoes.html

ll numOfTilings(int n) {
    int T[n + 1], g[n + 1], h[n + 1];
    mem(T, 0), mem(g, 0), mem(h, 0);
    T[1] = 1;
    T[2] = 5;
    g[1] = 1;
    g[2] = 1;
