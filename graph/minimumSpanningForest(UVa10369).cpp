...
///=======================================template=======================================///
/*
 * minimum spanning forest, s connected components and each an MST
 * idea: continue adding edges from lowest weights  until number of connected components are s.
 */
...
int main() {
    ...
    while (t--) {
        ...
        cout << fixed << setprecision(2) << sqrtl(mini) << endl;
